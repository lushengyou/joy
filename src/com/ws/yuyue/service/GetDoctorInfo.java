...
@XmlRootElement(name = "getDoctorInfo")
public class GetDoctorInfo {

    @XmlElement(name = "Message", required = true)
    protected GetDoctorInfo.Message message;
     ...
     * @return
     *     possible object is
     *     {@link GetDoctorInfo.Message }
     *     
     */
    public GetDoctorInfo.Message getMessage() {
        return message;
    }
     ...
     *     
     */
    public void setMessage(GetDoctorInfo.Message value) {
        this.message = value;
    }
    ...
    public static class Message {
        ...
        protected GetDoctorInfo.Message.RequestInfo requestInfo;
         ...
         * @return
         *     possible object is
         *     {@link GetDoctorInfo.Message.RequestInfo }
         *     
         */
        public GetDoctorInfo.Message.RequestInfo getRequestInfo() {
            return requestInfo;
        }
         ...
         *     
         */
        public void setRequestInfo(GetDoctorInfo.Message.RequestInfo value) {
