...
@XmlRootElement(name = "getDepartWorkInfo")
public class GetDepartWorkInfo {

    @XmlElement(name = "Message", required = true)
    protected GetDepartWorkInfo.Message message;
     ...
     * @return
     *     possible object is
     *     {@link GetDepartWorkInfo.Message }
     *     
     */
    public GetDepartWorkInfo.Message getMessage() {
        return message;
    }
     ...
     *     
     */
    public void setMessage(GetDepartWorkInfo.Message value) {
        this.message = value;
    }
    ...
    public static class Message {
        ...
        protected GetDepartWorkInfo.Message.RequestInfo requestInfo;
         ...
         * @return
         *     possible object is
         *     {@link GetDepartWorkInfo.Message.RequestInfo }
         *     
         */
        public GetDepartWorkInfo.Message.RequestInfo getRequestInfo() {
            return requestInfo;
        }
         ...
         *     
         */
        public void setRequestInfo(GetDepartWorkInfo.Message.RequestInfo value) {
