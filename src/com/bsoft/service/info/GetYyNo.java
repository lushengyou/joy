...
public class GetYyNo extends GetInfo
{
	private static Logger  log = Logger.getLogger(GetYyNo.class);
	private static GetYyNo instance = new GetYyNo();
	
	public static GetYyNo getInstance()
	{
		return instance;
	}
	...
	public int executeSqlBeforeYY(String departid, String doctorid, String isexpert, String worktype, String seedoctordate, String begintime, String endtime)
						...
						(endtime == null)))
		{
			if ("0".equals(isexpert)) {
				...
				sql = "select ygrs,ghxe from ms_kspb " + 
						"where tgbz = 0 and ghks = '"  + departid + "' " + 
						"and zblb = '" + worktype + "' " + 
						"and ghrq = '" + dayOfWeek + "'";
				returnList = dao.doQuery(sql);
...
//						"and a.ghrq = '" + seedoctordate + "'";
		...
		if ("0".equals(isexpert))
		{
			if ((("".equals(begintime)) || 
					(begintime == null)) && (
							...
							(endtime == null))) {
				String dayOfWeek = getDayOfWeek(seedoctordate);
				sql = "update MS_KSPB set jzxh = jzxh+1,ygrs = ygrs+1 where ghks = '" + 
						departid + "' " + 
						"and ghrq = '" + dayOfWeek + "' " + 
						"and zblb = '" + worktype + "'";
			}
	...
	public String getSqlSelectPB(String departid, String doctorid, String isexpert, String worktype, String seedoctordate, String begintime, String endtime)
	{
		...
		if ("0".equals(isexpert))
		{
			...
			{
				String dayOfWeek = getDayOfWeek(seedoctordate);
				sql = "select jzxh as reserveno from MS_KSPB where ghks = '" + 
						departid + "' " + 
						"and ghrq = '" + dayOfWeek + "' " + 
						"and zblb = '" + worktype + "'";
			}
